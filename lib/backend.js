...
, FAKE_DUMP_TO_FILE: function(path) {
    require('fs').writeFileSync(path, JSON.stringify(this.getRawData()));
    return OK;
  }
, FAKE_RESTORE_FROM_FILE: function(path) {
    this.setRawData(JSON.parse(require('fs').readFileSync(path)));
    return OK;
  }
};
